...
### CASA SVG Example
**Note**: This PNG was cropped and saved with a white background. Unedited CASA SVG outputs have transparent backgrounds and start with a 7.5in x 9in page size.
**Note**: Original SVG taken from our CASA OSF repository: https://osf.io/xnmha/
